...
useMeta({ title: 'Отчет по дизайнеру' });
                ...
                <div class="widget widget-statistics">
                    ...
                    <div class="widget-content">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label for="assembler">Дизайнер</label>
                                <select v-model="assembler" class="form-select form-select" id="assembler"
                                    @change="change">
                                    <option value="null" selected disabled>Выберите дизайнера</option>
                ...
                <div class="widget widget-statistics">
                    ...
                    <div class="widget-content">
                        <div class="row">
                            <div class="col-6">
                                <div class="w-detail">
                                    <p class="w-title">Всего заказов</p>
                                    <p class="w-stats">
