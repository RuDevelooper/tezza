                ...
                <div class="widget widget-unique-visitors">
                    ...
                    <div class="widget-content">
                        <apex-chart v-if="unique_visitor_options" height="350" type="bar"
                            :options="unique_visitor_options" :series="unique_visitor_series"></apex-chart>
                    </div>
                </div>
            </div>
                ...
                <div class="row widget-statistic">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                <div class="w-chart">
                                    <apex-chart v-if="referral_options" height="160" type="area"
                                        :options="referral_options" :series="referral_series"></apex-chart>
                                </div>
                            </div>
                        </div>
                    </div>
