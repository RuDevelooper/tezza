...
const columns = ref([
    ...
    'deadline',
    'order_items',
    'order_items_assembled',
    'order_items_assembled_percent',
    'issues',
    'assembler',
    'status',
    'actions',
...
const headings = {
    ...
    order_items: 'Изделий в заказе',
    order_items_assembled: 'Собрано',
    order_items_assembled_percent: '%',
    issues: 'Замечания',
    assembler: 'Сборщик',
    status: 'Статус',
                            ...
                            <template #name="props">
                                <div class="d-flex">
                                    <div class="usr-img-frame me-2 rounded-circle">
                                        <img :src="require('@/assets/images/' + props.row.thumb)"
