        ...
        <div class="row layout-top-spacing">
                    ...
                    <div class="widget-content">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <apex-chart v-if="paid_visit_options" height="58" type="line" :options="paid_visit_options"
                                    :series="paid_visit_series"></apex-chart>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-unique-visitors">
                    ...
                    <div class="widget-content">
                        <apex-chart v-if="unique_visitor_options" height="350" type="bar" :options="unique_visitor_options"
                            :series="unique_visitor_series"></apex-chart>
                    </div>
                </div>
            </div>
                ...
                <div class="row widget-statistic">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                <div class="w-chart">
                                    <apex-chart v-if="followers_options" height="160" type="area"
                                        :options="followers_options" :series="followers_series"></apex-chart>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                <div class="w-chart">
                                    <apex-chart v-if="referral_options" height="160" type="area" :options="referral_options"
                                        :series="referral_series"></apex-chart>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                <div class="w-chart">
                                    <apex-chart v-if="engagement_options" height="160" type="area"
                                        :options="engagement_options" :series="engagement_series"></apex-chart>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-card-three">
                    <div class="widget-heading">
                        ...
                        <div class="task-action">
                            <div class="dropdown btn-group">
                                <a href="javascript:;" id="ddlDesign" class="btn dropdown-toggle btn-icon-only"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-more-horizontal">
                    ...
                    <div class="widget-content">
                        <p>Doloribus nisi vel suscipit modi, optio ex repudiandae voluptatibus officiis commodi. Nesciunt
                            quas aut neque incidunt!</p>
                        <div class="progress-data">
                            ...
                            <div class="progress">
                                <div role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="65"
                                    class="progress-bar bg-primary" style="width: 65%"></div>
                            </div>
                        </div>
                        ...
                        <div class="meta-info">
                            ...
                            <div class="avatar--group">
                                ...
                                <span class="b-avatar avatar badge-default rounded">
                                    <span class="b-avatar-img"><img :src="require('@/assets/images/profile-8.jpeg')"
                                            alt="avatar" /></span>
                                </span>
                                <span class="b-avatar avatar badge-default rounded">
                                    <span class="b-avatar-img"><img :src="require('@/assets/images/profile-12.jpeg')"
                                            alt="avatar" /></span>
                                </span>
                                <span class="b-avatar avatar badge-default rounded">
                                    <span class="b-avatar-img"><img :src="require('@/assets/images/profile-19.jpeg')"
                                            alt="avatar" /></span>
                                </span>
                            </div>
                        </div>
