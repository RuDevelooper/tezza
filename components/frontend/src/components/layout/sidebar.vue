            ...
            <perfect-scrollbar class="list-unstyled menu-categories" tag="ul"
                ...
                <li class="menu">
                    <a class="dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#orders"
                        ...
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="feather feather-list" data-v-02c2cbc4="">
                    ...
                    <ul id="orders" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        ...
                        <li>
                            <router-link to="/orders/edit" @click="toggleMobileMenu">Изменить</router-link>
                        </li>
                        <li>
                ...
                <li class="menu">
                    <a class="dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#assembler"
                        ...
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-code" data-v-02c2cbc4="">
                                <polyline points="16 18 22 12 16 6"></polyline>
                                <polyline points="8 6 2 12 8 18"></polyline>
                            </svg>
                            <span>{{ $t('assembler') }}</span>
                        </div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <li class="menu">
                    <a class="dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#picker" aria-controls="picker"
                        ...
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-box" data-v-02c2cbc4="">
                                <path
                    ...
                    <ul id="picker" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        <li>
                            <router-link to="/picker/orders" @click="toggleMobileMenu">
                                {{ $t('orders') }}
                            </router-link>
                        </li>
                    </ul>
                ...
                <li class="menu">
                    <a class="dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#report" aria-controls="report"
                        ...
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-bar-chart-2" data-v-5522efca="">
                    ...
                    <ul id="report" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        <li>
                            <router-link to="/report/assembler" @click="toggleMobileMenu">
                                {{ $t('assembler') }}
                            </router-link>
                        </li>
                        <li>
                            <router-link to="/report/designer" @click="toggleMobileMenu">
                                Дизайнер
                            </router-link>
                        </li>
                    </ul>
                            ...
                            <ul id="appInvoice" class="collapse list-unstyled sub-submenu">
                                ...
                                <li>
                                    <router-link to="/apps/invoice/preview"
                                        @click="toggleMobileMenu">Preview</router-link>
                                </li>
                                <li>
                ...
                <li class="menu">
                    ...
                    <ul id="components" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        ...
                        <li>
                            <router-link to="/components/sweetalert" @click="toggleMobileMenu">Sweet
                                Alerts</router-link>
                        </li>
                        <li>
                        ...
                        <li>
                            <router-link to="/components/notifications"
                                @click="toggleMobileMenu">Notifications</router-link>
                        </li>
                        <li>
                            <router-link to="/components/media-object" @click="toggleMobileMenu">Media
                                Object</router-link>
                        </li>
                        <li>
                        ...
                        <li>
                            <router-link to="/components/pricing-table" @click="toggleMobileMenu">Pricing
                                Tables</router-link>
                        </li>
                        <li>
                ...
                <li class="menu">
                    ...
                    <ul id="elements" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        ...
                        <li>
                            <router-link to="/elements/buttons-group" @click="toggleMobileMenu">Button
                                Groups</router-link>
                        </li>
                        <li>
                            <router-link to="/elements/color-library" @click="toggleMobileMenu">Color
                                Library</router-link>
                        </li>
                        <li>
                        ...
                        <li>
                            <router-link to="/elements/progress-bar" @click="toggleMobileMenu">Progress
                                Bar</router-link>
                        </li>
                        <li>
                ...
                <li class="menu">
                    ...
                    <ul id="datatables" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        ...
                        <li>
                            <router-link to="/tables/order-sorting" @click="toggleMobileMenu">Order
                                Sorting</router-link>
                        </li>
                        <li>
                        ...
                        <li>
                            <router-link to="/tables/alt-pagination" @click="toggleMobileMenu">Alt.
                        ...
                        <li>
                            <router-link to="/tables/miscellaneous"
                                @click="toggleMobileMenu">Miscellaneous</router-link>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul id="forms" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        ...
                        <li>
                            <router-link to="/forms/checkbox-radio" @click="toggleMobileMenu">Checkbox &amp;
                                Radio</router-link>
                        </li>
                        <li>
                        ...
                        <li>
                            <router-link to="/forms/markdown-editor" @click="toggleMobileMenu">Markdown
                                Editor</router-link>
                        </li>
                        <li>
                            <router-link to="/forms/date-picker" @click="toggleMobileMenu">Date &amp; Range Picker
                            </router-link>
                        </li>
                        <li>
                ...
                <li class="menu">
                    ...
                    <ul id="users" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        ...
                        <li>
                            <router-link to="/users/account-setting" @click="toggleMobileMenu">Account
                ...
                <li class="menu">
                    ...
                    <ul id="pages" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        ...
                        <li>
                            <router-link to="/pages/privacy-policy" @click="toggleMobileMenu">Privacy
                                Policy</router-link>
                        </li>
                        ...
                        <li>
                            ...
                            <ul id="pages-error" class="collapse list-unstyled sub-submenu">
                                ...
                                <li @click="toggleMobileMenu"><a target="_blank"
                                        href="/pages/maintenence">Maintanence</a>
                                </li>
                            </ul>
                        </li>
